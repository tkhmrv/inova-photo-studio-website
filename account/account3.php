              ...
              <form>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="fullName" aria-describedby="fullNameHelp"
                    placeholder="Enter your fullname" value="Kenneth Valdez">
                  <small id="fullNameHelp" class="form-text text-muted">Your name may appear around here where you are
                    mentioned. You can change or remove it at any time.</small>
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane" id="security">
              ...
              <form>
                <div class="form-group">
                  ...
                  <p class="small text-muted mt-2">Two-factor authentication adds an additional layer of security to
              ...
              <form>
                <div class="form-group mb-0">
                  ...
                  <p class="font-size-sm text-secondary">This is a list of devices that have logged into your account.
              ...
              <form>
                <div class="form-group">
                  ...
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck1">Email each time a vulnerability is
                      found</label>
                  </div>
                  <div class="custom-control custom-checkbox">
